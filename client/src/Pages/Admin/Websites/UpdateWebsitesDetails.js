...
const UpdateWebsitesDetails = () => {
  ...
  useEffect(() => {
    const fetchWebsiteDetails = async () => {
      try {
        const response = await axios.get(`http://localhost:8800/api/websites/detaylar/${id}`);
        if (response.data) {
    ...
    const fetchImages = async () => {
      try {
        const response = await axios.get(`http://localhost:8800/api/websites/getImages/${id}`);
        if (response.data) {
  ...
  const handleAddNewImage = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8800/api/websites/addImages', newImage);
  ...
  const handleDeleteImage = async (imageId) => {
    try {
      ...
      const response = await axios.delete('http://localhost:8800/api/websites/deleteImage', {
  ...
  const handleUpdateImage = async (image) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8800/api/websites/updateImages', image, {
        headers: {
